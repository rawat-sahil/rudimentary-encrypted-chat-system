...
if __name__=="__main__":
    ...
    parser.add_option("-i", "--serverIP", dest="serverIP", action="store", type="string",
    ...
    parser.add_option("-k", "--caIP", dest="caIP", action="store", type="string",
                      help="specify the ip of the CA that you want to fetch the certificate from")
    parser.add_option("-l", "--caport", dest="caPort", action="store", type="int",
